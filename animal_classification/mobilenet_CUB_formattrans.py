...
# 定义路径
base_dir = r'D:\The all of python\animal classification\YOLO_dataset_CUB'
images_dir = os.path.join(base_dir, 'images')
labels_dir = os.path.join(base_dir, 'labels')
output_dir = r'D:\The all of python\animal classification\Mobile_ImageFolder_dataset_CUB'
